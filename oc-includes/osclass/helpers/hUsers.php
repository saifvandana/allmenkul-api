...
function osc_user_profile_img_url($id = null) {
  return (string) osc_apply_filter('user_profile_img_url', osc_base_url(). 'oc-content/uploads/user-images/' . osc_user_profile_img($id));
}
...
function osc_user_profile_img_path($id = null) {
  return (string) osc_apply_filter('user_profile_img_path', osc_base_url(). 'oc-content/uploads/user-images/' . osc_user_profile_img($id));
}
