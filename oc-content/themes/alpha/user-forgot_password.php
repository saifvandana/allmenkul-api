...
<body id="body-user-forgot-password">
  ...
  <h2><span><?php _e('Reset', 'alpha'); ?></span> <?php _e('password', 'alpha'); ?></h2>
  ...
  <div class="user_forms">
      <div class="inner">
        ...
        <fieldset>
          <div>
            <label for="new_email"><?php _e('New password', 'alpha') ; ?></label>
            <input type="password" name="new_password" value="" />
          </div>
          <div>
            <label for="new_email"><?php _e('Repeat password', 'alpha') ; ?></label>
            <input type="password" name="new_password2" value="" />
          </div>

          <button type="submit"><?php _e('Submit', 'alpha') ; ?></button>
        </fieldset>
        </form>
      </div>
    </div>
