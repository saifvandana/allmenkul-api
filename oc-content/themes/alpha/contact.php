        ...
        <div class="user_forms login">
          <div class="inner">
            <form action="<?php echo osc_base_url(true) ; ?>" method="post" name="contact_form" id="contact" <?php if(osc_contact_attachment()) { ?>enctype="multipart/form-data"<?php } ?>>
              ...
              <label for="yourName"><span><?php _e('Email', 'alpha'); ?></span><span class="req">*</span></label> 
              <div class="input-box">
              ...
              <label for="subject"><span><?php _e('Subject', 'alpha'); ?></span><span class="req">*</span></label>
                ...
                <div class="attachment att-box">
                  <div class="att-wrap">
                    <label class="att-label">
                      <span class="att-btn"><?php _e('Choose a file', 'alpha'); ?></span>
                      <span class="att-text"><?php _e('No file selected', 'alpha'); ?></span>
              ...
              <button type="submit" class="btn alpBg"><?php _e('Send', 'alpha'); ?></button>
