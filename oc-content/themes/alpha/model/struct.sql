DROP TABLE IF EXISTS /*TABLE_PREFIX*/t_item_alpha;
CREATE TABLE /*TABLE_PREFIX*/t_item_alpha(
...
INSERT INTO /*TABLE_PREFIX*/t_item_alpha (fk_i_item_id) SELECT pk_i_id FROM /*TABLE_PREFIX*/t_item;

DROP TABLE IF EXISTS /*TABLE_PREFIX*/t_item_stats_alpha;
CREATE TABLE /*TABLE_PREFIX*/t_item_stats_alpha(
...
DROP TABLE IF EXISTS /*TABLE_PREFIX*/t_category_alpha;
CREATE TABLE /*TABLE_PREFIX*/t_category_alpha(
...
INSERT INTO /*TABLE_PREFIX*/t_category_alpha (fk_i_category_id) SELECT pk_i_id FROM /*TABLE_PREFIX*/t_category;
