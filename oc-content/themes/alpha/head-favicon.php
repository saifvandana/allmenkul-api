<?php
  ...
  require_once ABS_PATH . 'oc-content/themes/alpha/functions.php';

  $path = osc_base_path() . 'oc-content/themes/alpha/images/favicons/';
  $url = osc_base_url() . 'oc-content/themes/alpha/images/favicons/';
?>
