...
<script type="text/javascript">
  var alpCurrentLocale = '<?php echo osc_esc_js($current_locale['s_name']); ?>';
  var fileDefaultText = '<?php echo osc_esc_js(__('No file selected', 'alpha')); ?>';
  var fileBtnText     = '<?php echo osc_esc_js(__('Choose File', 'alpha')); ?>';
  var baseDir = "<?php echo osc_base_url(); ?>";
  var baseSearchUrl = '<?php echo osc_search_url(array('page' => 'search')); ?>';
  var baseAjaxUrl = '<?php echo alp_ajax_url(); ?>';
  ...
  var alpLazy = '<?php echo alp_is_lazy(); ?>';
  var alpMasonry = '<?php echo osc_get_preference('force_aspect_image', 'osclass') == 1 ? 1 : 0; ?>';
  ...
  var ajaxSearch = '<?php echo (alp_param('search_ajax') == 1 ? '1' : '0'); ?>';
  var ajaxForms = '<?php echo (alp_param('forms_ajax') == 1 ? '1' : '0'); ?>';
  var locationPick = '<?php echo (alp_param('location_pick') == 1 ? '1' : '0'); ?>';
  var alpTitleNc = '<?php echo osc_esc_js(__('Parent category cannot be selected', 'alpha')); ?>';
...
if(alp_ajax_image_upload() && (osc_is_publish_page() || osc_is_edit_page())) {
