...
class AuthorizeNetAIM extends AuthorizeNetRequest
{
    ...
    //const SANDBOX_URL = 'https://secure2.authorize.net/gateway/transact.dll';
    ...
    {
	//	$main_config = Kohana::$config->load('main_config');
        //$company_ips = $main_config->our_company_ips;
	//	$session = Session::instance();
	//	if (is_array($company_ips) AND in_array(Request::$client_ip, $company_ips)){
	//		$this->test_request = 'TRUE';
	//		$session->set('test_request', true);
	//	}
