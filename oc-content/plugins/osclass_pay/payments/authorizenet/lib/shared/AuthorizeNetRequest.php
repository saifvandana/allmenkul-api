...
abstract class AuthorizeNetRequest
{
    ...
    protected $_last_curl_err = CURLM_OK;
    /**
	...
	curl_setopt($curl_request, CURLOPT_CONNECTTIMEOUT, 45);
	...
	$this->_last_curl_err = curl_errno($curl_request);
